...
def main():
    ...
    with st.sidebar:
        ...
        pdf_docs = st.file_uploader("Upload your PDF's here and click on process to continue", accept_multiple_files=True)
        if st.button("Process"):
            with st.spinner("Processing"):
                # 1.get the text from pdf
                ...
                # create an instance of the conversation chain
